...
| **3b-2** | `KuhnTuckerLoweringPass` (Fischer-Burmeister NCP) + vector-unknown local Newton + multi-surface; rank-4 `tensor_inv` (numsim-cas#276 / #43) | New pass before LocalJacobian; LNS solver refactor | future |
